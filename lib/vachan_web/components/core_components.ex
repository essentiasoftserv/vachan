defmodule VachanWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-customBackground p-14 shadow-lg ring-1 transition"
            >
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-8 bg-customBackground p-4">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VachanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VachanWeb.Gettext, "errors", msg, opts)
    end
  end
